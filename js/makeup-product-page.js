...
if (localStorage.getItem("makeup") == null)
{
   makeupcontainer = [];
...
{
    makeupcontainer= JSON.parse(localStorage.getItem("makeup"));
   console.log(makeupcontainer[2])
   typeComment.style.display = "none";
   sendComment.style.display = "none" ;
   makeSureIfLSEmpty();
...
{ 
 ...
 function makeSureIfLSEmpty()
  { 
         var temp = "";
         for (var i = 0 ; i < makeupcontainer.length ; i++)
         {
          temp += `<div class="col-md-3">
          <img src="../imges/bbbb.jpg" class="w-100 my-2" >
           </div>
           <div  class="col-md-9">             
           <span class="my-2 displayEmpty">`+makeupcontainer[i].makeup+`</span>
           </div>`;
